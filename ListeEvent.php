...
<body>
	...
	<header class="top-navbar">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container">
				<a class="navbar-brand" href="http://localhost/FinalProject/Views/user/compte.php">
					...
					<div class="col-lg-4 col-md-6 col-12">
						<div class="blog-box-inner">
							...
							<div class="blog-detail">
								...
								<a class="btn btn-lg btn-circle btn-outline-new-white" href="rate.php?idEvent=<?php echo $event["id"]; ?>">Rate</a>
								<a class="btn btn-lg btn-circle btn-outline-new-white" href="AjouterReservation.php?idEvent=<?php echo $event["id"]; ?>">Reserver</a>
								<a class="btn btn-lg btn-circle btn-outline-new-white" href="ListeReservation.php?idEvent=<?php echo $event["id"]; ?>">voir reservation</a>
							</div>
						</div>
					</div>
				<?php
