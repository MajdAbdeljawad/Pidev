            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                                                    ...
                                                    <div class="col-12 grid-margin stretch-card">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <form class="form-inline" action="ajout.php" method="post">
                                                                    <label class="sr-only" for="inlineFormInputName2">Nom</label>
                                                                    <input type="text" name="nom" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2">
                                                                    <label class="sr-only" for="inlineFormInputName2">Date</label>
                                                                    <input type="date" name="date" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2">
                                                                    <label class="sr-only" for="inlineFormInputName2">Prix</label>
                                                                    <input type="text" name="prix" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2">
                        ...
                        <script>
                            function button_toggle(x) {
                                $("#panier_orderId" + x).toggle(10)
